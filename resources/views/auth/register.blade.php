        ...
        <ul class="navbar-nav nav-flex-icons">
          ...
          <li class="nav-item">
            <a href="{{ route('login') }}" class="nav-link border border-light rounded"
              target="_blank">
              <i class="fas fa-key prefix grey-text"></i>Login
            </a>
          </li>
        </ul>
          ...
          <div class="col-md-6 col-xl-5 mb-4">
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                <!-- Form -->
                <form name=""  method="POST" action="{{ route('register') }}">
                     {{ csrf_field() }}
                  <!-- Heading -->
                  ...
                  <div class="md-form">
                    ...
                    <input type="text" id="password" placeholder="Password" name="password" value="{{ old('password') }}" class="form-control">
